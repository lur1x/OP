...
VAR
  Ch1, Ch2, Ch3: CHAR;
BEGIN{ReadMonth}
  IF NOT EOLN(FIn){FIn содержит хотя бы 3 симовола}
  THEN
    BEGIN
      READ(FIn, Ch1);
      IF NOT EOLN(FIn)
