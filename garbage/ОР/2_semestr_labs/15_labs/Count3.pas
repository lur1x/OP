...
INTERFACE{INTERFACE}
VAR
  Ones, Tens, Hundreds, Thousend: CHAR;
PROCEDURE Start;{Инициализация счетчика}
PROCEDURE Bump(VAR Thousend: CHAR);{Увеличивает счётчик на едницу, елси он находится в диапазоне }
...
PROCEDURE Bump(VAR Thousend: CHAR);
