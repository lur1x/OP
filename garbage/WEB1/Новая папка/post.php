...
<head>
    ...
    <link rel="stylesheet" href="styles/post-the-road.css">
</head>
<body>  
    <header class="header">
        <div class="header__container">
            <div class="header__button">
                <a class="header__escape" href="#">Escape.</a>
            </div>
            <nav class="header__navigation">
                <ul class="header__navigation__list">
                    <li class="navigation-item"><a class="header__navigation-link" href="#">HOME</a></li>
                    <li class="navigation-item"><a class="header__navigation-link" href="#">CATEGORIES</a></li>
                    <li class="navigation-item"><a class="header__navigation-link" href="#">ABOUT</a></li>
                    <li class="navigation-item"><a class="header__navigation-link" href="#">CONTACT</a></li>
                </ul>
            </nav>
        </div>
    </header>
    <main class="main">
        <div class="title">
            ...
            <div class="subtitle">The road ahead might be paved - it might not be.</div>
        </div>
        <img class="northern-lights" src="images/northern-lights.jpg" alt="Northerhn-lights">
        <div class="text-block">
            <p> 
                ...
                pulseless as the abysses of space.<br>
                <br>
            </p>
        </div>
    </main>
    <footer class="footer">
        <div class="footer__container">
            <div class="footer__button">
                <a class="footer__escape" href="#">Escape.</a>
            </div>
            <nav class="footer__navigation">
                <ul class="footer__navigation__list">
                    <li class="navigation-item"><a class="footer__navigation-link" href="#">HOME</a></li>
                    <li class="navigation-item"><a class="footer__navigation-link" href="#">CATEGORIES</a></li>
                    <li class="navigation-item"><a class="footer__navigation-link" href="#">ABOUT</a></li>
                    <li class="navigation-item"><a class="footer__navigation-link" href="#">CONTACT</a></li>
                </ul>
            </nav>
        </div>
    </footer>
